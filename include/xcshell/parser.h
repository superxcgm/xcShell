...
class Parser {
 ...
 private:
  ...
  static std::optional<std::vector<std::string>> SplitArgs(const std::string& str);
  ...
  static std::optional<std::pair<std::string, int>> ExtractQuoteString(int start, char quotation_mark,
                                                 const std::string &str, std::ostream &os_err);
  static std::optional<std::pair<std::string, int>> ExtractStringWithoutQuote(int start, const std::string &str);
